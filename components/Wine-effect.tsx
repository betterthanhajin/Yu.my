...
export default function WineEffect(WineEffectProps: WineEffectProps) {
  return (
    <div
      style={{
        // position: "absolute",
        // top: WineEffectProps.position.y,
        // left: WineEffectProps.position.x,
        width: "100%",
        height: "100%",
        zIndex: -1,
      }}
